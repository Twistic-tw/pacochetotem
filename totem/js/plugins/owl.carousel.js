    ...
    var Carousel = {
        ...
        goTo : function (position, speed, drag) {
            ...
            if (position == "0" )
            {
                ...
                var fondo =  $('#fondo_hoy').data('fondo') ;
            ...
            if (position == "1" )
            {
                    var fondo2 = $('#fondo_tomorrow').data('fondo' );

                         $('.background_tiempo').css('background-image','url("'+fondo2+'") ');
            } 

            if (position == "2" )
            {
                    var fondo3 = $('#fondo_pasado').data('fondo');

                         $('.background_tiempo').css('background-image','url("'+fondo3+'") ');
        ...
        gestures : function () {
            ...
            function dragStart(event) {
                ...
                if (base.browser.isTouch !== true && !base.$owlWrapper.hasClass("grabbing")) {
                    ...
                    //alert('movimiento swipe');

/*                     $('.background_tiempo').css('background-color','#59ABE3');

                    //$('.background_tiempo').fadeOut(700);
