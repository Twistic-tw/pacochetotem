...
function initialize(hotel_longitud,hotel_latitud,JSON_posicion_farmacia, mapa) {
    ...
    var image = new google.maps.MarkerImage('../../../contenido_proyectos/pacoche/_general/iconos/gasolina_marcador.png', new google.maps.Size(32, 36), new google.maps.Point(0, 0));
