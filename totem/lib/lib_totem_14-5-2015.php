...
function getFechaActual_no_year()
{
    switch ($_SESSION['idioma']) {
        case 1:
            setlocale(LC_ALL, "es_ES.UTF-8");
        ...
        default:
            ...
            setlocale(LC_TIME, 'spanish');
            $fecha = utf8_encode(strftime("%A %d de %B"));
            break;
    }
    return $fecha;
}

function getFecha2_no_year()
{
    switch ($_SESSION['idioma']) {
        case 1:
            setlocale(LC_ALL, "es_ES.UTF-8");
            ...
            setlocale(LC_TIME, 'spanish');
            $fecha = strftime("%A %d de %B", strtotime('+ 1day'));
            break;
        ...
        case 2:
            ...
            setlocale(LC_TIME, "english");
            $fecha = strftime("%A %B %d", strtotime('+ 1day'));
            break;
        ...
        case 3:
            ...
            setlocale(LC_TIME, 'german');
            $fecha = strftime("%A %d. %B", strtotime('+ 1day'));
            break;
        ...
        default:
            ...
            setlocale(LC_TIME, 'spanish');
            $fecha = utf8_encode(strftime("%A %d de %B", strtotime('+ 1day')));
            break;
    }
    return $fecha;
}

function getFecha3_no_year()
{
    switch ($_SESSION['idioma']) {
        case 1:
            setlocale(LC_ALL, "es_ES.UTF-8");
            ...
            setlocale(LC_TIME, 'spanish');
            $fecha = strftime("%A %d de %B", strtotime('+ 2day'));
            break;
        ...
        case 2:
            ...
            setlocale(LC_TIME, "english");
            $fecha = strftime("%A %B %d", strtotime('+ 2day'));
            break;
        ...
        case 3:
            ...
            setlocale(LC_TIME, 'german');
            $fecha = strftime("%A %d. %B", strtotime('+ 2day'));
            break;
        ...
        default:
            ...
            setlocale(LC_TIME, 'spanish');
            $fecha = utf8_encode(strftime("%A %d de %B", strtotime('+ 2day')));
            break;
    }
    return $fecha;
}
...
function totem_listado_actividades_info($fecha, $idioma=1) {
    ...
    $sql = "SELECT  t4.title, t4.content, t4.lugar, t4.foto_evento,
                    ...
                    t6.icon, t6.color, t6.lugar as cat_lugar
                FROM eventos_ocurrencias as t1, 
                eventos as t2, 
                eventos_categorias as t3, 
                eventos_contenido as t4, 
                eventos_categorias as t5,
                eventos_lugares as t6
                WHERE t1.fecha = '$fecha' 
                    AND t1.id_centro = $id_centro 
    ...
    while ($fila = $db->fetch_array($consulta)){
        if ( $fila['nombre'] == "Hotel"){
            $fechas['hotel'][] = array ( "repeticiones"=>$fila['repeticiones'], "fecha_ini"=>$fila['fecha_ini'], "fecha_fin"=>$fila['fecha_fin'], "icon_cat"=>$fila['icon_cat'], 
                                      ...
                                      "lugar"=>$fila['lugar'], "foto_evento"=>$fila['foto_evento'], "icon" => $fila['icon'], "color" => $fila['color'], "cat_lugar" => $fila['cat_lugar'] );
...
function totem_getActividades3dias($id_centro, $fecha, $idioma=1) {
    ...
    $sql = "SELECT DISTINCT t1.fecha,
                ...
                FROM
                    ...
                    eventos t2,
                    eventos_categorias t3,
                    eventos_contenido t4,
                    eventos_categorias t5,
                    eventos_lugares t6,
    ...
    while ($fila = $db->fetch_array($consulta)){
        if ($fila['nombre'] == "Hotel") {
            $fechas['hotel'][$fila['fecha']][] = 
                                array ( "lugar"=>$fila['lugar'], "repeticiones"=>$fila['repeticiones'], "fecha_ini"=>$fila['fecha_ini'], "fecha_fin"=>$fila['fecha_fin'], "icon_cat"=>$fila['icon_cat'], 
                                      "icon_subcat"=>$fila['icon_subcat'], "hora_ini"=>$fila['hora_ini'], "hora_fin"=>$fila['hora_fin'], "nombre_cat"=>$fila['nombre'], 
    ...
    while ($fila = $db->fetch_array($consulta)){
        if ($fila['nombre'] == "Hotel") {
            $fechas['hotel'][$fila['fecha']][$fila['lugar']][] = 
                                array ( "repeticiones"=>$fila['repeticiones'], "fecha_ini"=>$fila['fecha_ini'], "fecha_fin"=>$fila['fecha_fin'], "icon_cat"=>$fila['icon_cat'], 
                                      "icon_subcat"=>$fila['icon_subcat'], "hora_ini"=>$fila['hora_ini'], "hora_fin"=>$fila['hora_fin'], "nombre_cat"=>$fila['nombre'], 
                                      "id_categoria"=>$fila['id_cat'], "padre"=>$fila['padre'], "titulo_evento"=>$fila['title'], "contenido"=>$fila['content'], "foto_evento"=>$fila['foto_evento'], "video_evento"=>$fila['video_evento'], "id_evento"=>$fila['id_evento'], 
                                      "id_lugar"=>$fila['id_lugar'], "lugar"=>$fila['lugar'], "icon_lugar"=>$fila['icon_lugar'], "color_lugar"=>$fila['color_lugar'], "nombre_lugar"=>$fila['nombre_lugar']);
        ...
        elseif($fila['nombre_padre'] == "Hotel") {
            ...
            $fechas['isla'][$fila['fecha']][$fila['lugar']][] = 
                                array ( "repeticiones"=>$fila['repeticiones'], "fecha_ini"=>$fila['fecha_ini'], "fecha_fin"=>$fila['fecha_fin'], "icon_cat"=>$fila['icon_cat'], 
                                      "icon_subcat"=>$fila['icon_subcat'], "hora_ini"=>$fila['hora_ini'], "hora_fin"=>$fila['hora_fin'], "nombre_cat"=>$fila['nombre'], 
                                      "id_categoria"=>$fila['id_cat'], "padre"=>$fila['padre'], "titulo_evento"=>$fila['title'], "contenido"=>$fila['content'],"foto_evento"=>$fila['foto_evento'], "video_evento"=>$fila['video_evento'], "id_evento"=>$fila['id_evento'], 
                                      "id_lugar"=>$fila['id_lugar'], "lugar"=>$fila['lugar'], "icon_lugar"=>$fila['icon_lugar'], "color_lugar"=>$fila['color_lugar'], "nombre_lugar"=>$fila['nombre_lugar']);
...
function totem_tiempoCodesToString($estado) {
    ...
    $tiempoIdiomas["1"] = array ("11"=>"Despejado", "11n"=>"Despejado noche",
    ...
    $tiempoIdiomas["2"] = array ("11"=>"Cloudless", "11n"=>"Cloudless night",
    ...
    $tiempoIdiomas["3"] = array ("11"=>"Cloudless", "11n"=>"Cloudless night",
                                  "12"=>"Few clouds", "12n"=>"Few clouds night",
                                  "13"=>"Few clouds", "13n"=>"Few clouds night",
                                  "14"=>"Cloudy", "14n"=>"Cloudy night",
                                  "15"=>"Very cloudy", "15n"=>"Very cloudy night",
...
function totem_getSectionsInCategoria($categoriaId, $conComercios = false){
    ...
    if ($conComercios)
    {   //solo la ssecciones definidsa y con comercios asociados.
    ...
    {   //devolvemos todas las secciones definidas tengan o no comercios asociados
