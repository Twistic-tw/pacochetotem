...
function totem_listado_actividades_agenda_json() {
    ...
    $sql = "SELECT DISTINCT t1.fecha, t2.id_cat  
                FROM eventos_ocurrencias as t1, eventos as t2
...
function totem_listado_actividades_info($fecha, $idioma=1) {
   ...
   $sql = "SELECT  t4.title, t4.content, t4.lugar, t4.foto_evento, t3.nombre,
                    t2.hora_ini, t2.hora_fin, t2.repeticiones, t2.fecha_ini, t2.fecha_fin, t2.id_evento, t2.id_cat, 
                    t6.id_lugar, t6.icon, t6.color, t7.nombre as cat_lugar
                FROM
    ...
    while ($fila = $db->fetch_array($consulta)){
            ...
            $fechas['hotel'][] = array ( "repeticiones"=>$fila['repeticiones'], "fecha_ini"=>$fila['fecha_ini'], "fecha_fin"=>$fila['fecha_fin'],
...
function obtener_evento_destacado($fecha, $idioma=1) {
    ...
    $sql = "SELECT  t4.title, t4.content, t4.lugar, t4.foto_evento, t3.nombre,
                    t2.hora_ini, t2.hora_fin, t2.repeticiones, t2.fecha_ini, t2.fecha_fin, t2.id_evento, t2.id_cat,
                    t6.icon, t6.color, t7.nombre as cat_lugar
                FROM
                    eventos_ocurrencias t1,
                    eventos t2,
                    eventos_contenido t4,
    ...
    while ($fila = $db->fetch_array($consulta)){
        ...
        $fechas['hotel'][] = array ( "id"=>$fila['id_evento'],"repeticiones"=>$fila['repeticiones'], "fecha_ini"=>$fila['fecha_ini'], "fecha_fin"=>$fila['fecha_fin'],
                                     "hora_ini"=>$fila['hora_ini'], "hora_fin"=>$fila['hora_fin'], "titulo_evento"=>$fila['title'], "contenido"=>$fila['content'],
...
function totem_getActividades3dias($id_centro, $fecha, $idioma=1) {
   ...
   $sql = "SELECT DISTINCT t1.fecha,
    ...
    $fechas['hotel'][$fila['fecha']][$fila['lugar']][] = 
        array ( "repeticiones"=>$fila['repeticiones'], "fecha_ini"=>$fila['fecha_ini'], "fecha_fin"=>$fila['fecha_fin'], "hora_ini"=>$fila['hora_ini'], "hora_fin"=>$fila['hora_fin'], 
...
function totem_getActividadesSemanas($id_centro, $fecha, $idioma=1) {
    ...
    $sql = "SELECT DISTINCT t1.fecha,
                    t4.title, t4.content, t4.foto_evento, t4.video_evento,
                    t2.hora_ini, t2.hora_fin, t2.repeticiones, t2.fecha_ini, t2.fecha_fin, t2.id_evento, t2.id_cat, 
                    t6.id_lugar, t6.lugar, t6.icon as icon_lugar, t6.color as color_lugar, t7.nombre as nombre_lugar, t2.id_cat
                FROM
                    eventos_ocurrencias t1,
                    eventos t2,
                    eventos_categorias t3,
