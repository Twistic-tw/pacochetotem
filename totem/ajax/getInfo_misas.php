...
$tpl_info_general = new TemplatePower("plantillas/seccion_info_misas.html", T_BYFILE);
$tpl_info_general->prepare();

registrarLog("informacion", "misas");

$resultado = array();

$tpl_info_general->assign("informacion_title", LANG_INFO_MISAS_TITLE);
