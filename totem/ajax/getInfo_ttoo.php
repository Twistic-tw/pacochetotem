...
$tpl_info_general = new TemplatePower("plantillas/seccion_info_ttoo.html", T_BYFILE);
$tpl_info_general->prepare();

registrarLog("informacion", "touroperadores");

$resultado = array();

$tpl_info_general->assign("informacion_title", LANG_INFO_TTOO_TITLE);
$tpl_info_general->assign("lang_atras", LANG_GLOBAL_ATRAS);

$informacion= get_info($_SESSION['idioma'], 6);
