...
$tpl_sostenibilidad = new TemplatePower("plantillas/pagina_sostenibilidad.html", T_BYFILE);
...
$tpl_sostenibilidad->assign("element_id","sostenibilidad_link_id");
$tpl_sostenibilidad->assign("element_class","onerow block_2");
$tpl_sostenibilidad->assign("element_href","getSostenibilidad"); //Cambiar la ruta de esto
