...
$tpl_sostenibilidad = new TemplatePower("plantillas/pagina_sultan.html", T_BYFILE);
...
$tpl_sostenibilidad->assign("element_id","sultan_link_id");
$tpl_sostenibilidad->assign("element_class","onerow block_2");
$tpl_sostenibilidad->assign("element_href","getSultan"); //Cambiar la ruta de esto
