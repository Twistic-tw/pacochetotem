...
$tpl_destinos = new TemplatePower("plantillas/pagina_destinos.html", T_BYFILE);
$tpl_destinos->prepare();

$tpl_destinos->assign("destinos_title", LANG_DESTINOS_TITLE);

$tpl_destinos->newBlock("contentBlockLink");
$tpl_destinos->assign("element_id","destino_link_id");
$tpl_destinos->assign("element_class","onerow block_2");
$tpl_destinos->assign("element_href","getDestino_listadoZonas"); //Cambiar la ruta de esto
