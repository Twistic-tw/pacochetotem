...
$tpl_sostenibilidad = new TemplatePower("plantillas/pagina_hoteles.html", T_BYFILE);
...
$tpl_sostenibilidad->assign("element_id","hoteles_link_id");
$tpl_sostenibilidad->assign("element_class","onerow block_2");
$tpl_sostenibilidad->assign("element_href","getHoteles"); //Cambiar la ruta de esto
