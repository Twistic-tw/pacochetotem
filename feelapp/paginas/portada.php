...
$tpl_portada->assign('fondo_principal','https://view.twisticdigital.com/contenido_proyectos/pacoche/centro_'.$_SESSION['id_centro'].'/feelapp/fondo.webp');
...
//    $iconos_portada .= '<a data-enlace="calendario" href="#" class="menu-item item-2 enlace-pagina"> <img class="css_imagen_menu_hexagono css_png_portada" src="https://view.twisticdigital.com/contenido_proyectos/dunas/_general/feelapp/iconos/animacion_calendario.svg"> <div class="css_titulo_menu_hexagono"> '.LANG_FEELAPP_ENTRETENIMIENTO.'</div>  </a>';
    ...
    // $iconos_portada .= '<a data-url="nuestros-hoteles" data-titulo="Nuestros hoteles" target="_blank" href="https://www.hotelesdunas.com/es/" class="menu-item item-2"> <img class="css_imagen_menu_hexagono" src="https://view.twisticdigital.com/contenido_proyectos/dunas/_general/feelapp/iconos/dunas_hotel.png"> <div class="css_titulo_menu_hexagono"> '.LANG_FEELAPP_NUESTROS_HOTELES.'</div>  </a>';
    $iconos_portada .= '<a data-url="nuestros-hoteles" data-titulo="Nuestras habitaciones" data-enlace="categoria-77" href="#" class="menu-item item-2 enlace-pagina"> <img class="css_imagen_menu_hexagono" src="https://view.twisticdigital.com/contenido_proyectos/dunas/_general/feelapp/iconos/cama.png"> <div class="css_titulo_menu_hexagono"> '.LANG_NUESTRAS_HABITACIONES.'</div>  </a>';
    $iconos_portada .= '<a data-url="servicios" data-titulo="Servicios" data-enlace="categoria-78" href="#" class="menu-item item-2 enlace-pagina"> <img class="css_imagen_menu_hexagono" src="https://view.twisticdigital.com/contenido_proyectos/pacoche/_general/feelapp/iconos/campana.png"> <div class="css_titulo_menu_hexagono"> '.LANG_FEELAPP_SERVICIOS.'</div>  </a>';
    $iconos_portada .= '<a data-url="eventos" data-titulo="Eventos y reuniones" data-enlace="categoria-81" href="#" class="menu-item item-2 enlace-pagina"> <img class="css_imagen_menu_hexagono" src="https://view.twisticdigital.com/contenido_proyectos/pacoche/_general/feelapp/iconos/front-desk.png"> <div class="css_titulo_menu_hexagono"> '.LANG_FEELAPP_EVENTOS.'</div>  </a>';
